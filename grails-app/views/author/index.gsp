		...
		<div id="list-author" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="middleName" title="${message(code: 'author.middleName.label', default: 'Middle Name')}" />
				...
				<g:each in="${authorInstanceList}" status="i" var="authorInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: authorInstance, field: "middleName")}</td>
